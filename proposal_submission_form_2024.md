...
##### `We plan on addressing the problem of patients inaction of preventative care by creating a digital platform that uses a reward system and managing system for health screenings'
...
#### Team Coordinator GitHub Username: `brfraire`

#### Team Members `Evelyn Wang (evewang), Chuks Azubuike (c-azubuike), Craig Lewis (CraigsArray)`
